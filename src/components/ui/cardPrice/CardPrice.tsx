...
const CardPrice = ({priceCard}: PriceCard) => {
    ...
    <section className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12 px-4">
        {priceCard.map((card, index) => (
            ...
            >
            <div onClick={rotateCard} className="rotateCard relative w-full transition-transform duration-400 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
