        ...
        <main className="text-white min-h-screen px-6 py-20">
            <motion.section
                ...
                <p className="text-gray-400 text-lg leading-relaxed">
                    Ми — креативна digital-студія, яка спеціалізується на створенні сучасних сайтів, що не просто виглядають красиво, а й приносять реальний результат. Наш підхід базується на поєднанні естетики, інноваційних технологій і глибокого розуміння бізнес-цілей клієнта. Ми віримо, що сайт — це не набір сторінок, а інструмент, який формує репутацію компанії, допомагає залучати нових клієнтів і підкреслює унікальність бренду
                </p>
            </motion.section>
            ...
            {sections.map((sec, i) => (
                ...
                {sec.list && (
                    <ul className="text-gray-400 space-y-3 list-disc pl-5 mt-4">
